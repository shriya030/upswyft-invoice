 ...
 const fileSelectedHandler = (event) => {
  ...
  return (
    ...
    <PDFExport ref={pdfExportComponent} paperSize="A4">
      ...
      <h1 style={{textAlign: "center", fontSize: "2.5rem"}}>Purchase Order</h1>
        ...
        <div className="flex mt-40" pdfMode={invoice.pdfMode}>
          <div className="w-55" pdfMode={invoice.pdfMode}>
            <div
              className="bold dark mb-5">Bill To:</div>
            <EditableInput
            ...
            <div className="flex bg-gray p-5" pdfMode={invoice.pdfMode}>
              ...
              <div className="w-50 p-5 flex" pdfMode={invoice.pdfMode}>
                <EditableInput
                  ...
                  pdfMode={invoice.pdfMode}
                />
                <Text className="right bold dark w-auto" pdfMode={invoice.pdfMode}>
        ...
        <div className="mt-20" pdfMode={invoice.pdfMode}>
          <div
            className="bold w-100">Notes</div>
          <EditableTextarea
            className="w-100"
            rows={2}
            value={invoice.notes}
      ...
      <div className="btn">
      <Button primary={true} onClick={handleExportWithComponent}>Download</Button>
    </div>
    </div>
  )
